...
struct MainMenuScene {
    ...
    static void OnEnter(void* context) {
        ...
        app->menu.AddItem(
            "First popup", nullptr, TestApp::MenuSelection_One, &MainMenuScene::OnMenuChoice, app);
        app->menu.AddItem(
            "Second popup", nullptr, TestApp::MenuSelection_Two, &MainMenuScene::OnMenuChoice, app);
